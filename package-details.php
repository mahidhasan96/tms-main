...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<input type="hidden" id="price" value="<?php print $result->PackagePrice;?>" name="">
			<div class="bnr-right">
				<label class="inputLabel">To</label>
				<input class="date" onchange="Myfuction()" id="datepicker1" type="text" placeholder="dd-mm-yyyy" name="todate" required="">
			</div>
			</div>
						<div class="clearfix"></div>
				<div class="grand">
					<p>Grand Total</p>
					<h3 id="amount">Select Date</h3>
				</div>
			</div>
...
<script type="text/javascript">
	function Myfuction(){
		...
		var y=document.getElementById('datepicker1').value;
		var price=document.getElementById('price').value
		const date1 = new Date(x);
const date2 = new Date(y);
const diffTime = Math.abs(date2 - date1);
const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24)); 
var amt=price*diffDays
$("#amount").html(amt)
	}
</script>
